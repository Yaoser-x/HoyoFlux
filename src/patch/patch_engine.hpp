...
// Undo an applied plan: restore original bytes in reverse order and release
// the RemoteState block. Only safe while the game has not run the patched
// code yet (or after it exited).
